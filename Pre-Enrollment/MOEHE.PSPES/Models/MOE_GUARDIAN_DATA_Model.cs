...
namespace MOEHE.PSPES.Models
{
    ...
    class MOE_GUARDIAN_DATA_Model
    {
        ...
        //public virtual MOE_EMPLOYER_TYPE MOE_EMPLOYER_TYPE { get; set; }
        //public virtual MOE_MARITAL_STATUS MOE_MARITAL_STATUS { get; set; }
        //public virtual MOE_RELATIONSHIP MOE_RELATIONSHIP { get; set; }
    }
}
