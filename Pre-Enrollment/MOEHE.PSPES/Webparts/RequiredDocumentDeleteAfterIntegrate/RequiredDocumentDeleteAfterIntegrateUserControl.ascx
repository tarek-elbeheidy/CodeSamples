...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="RequiredDocumentDeleteAfterIntegrateUserControl.ascx.cs" Inherits="MOEHE.PSPES.Webparts.RequiredDocumentDeleteAfterIntegrate.RequiredDocumentDeleteAfterIntegrateUserControl" %>
...
<asp:GridView ID="gvRequiredDocuments" AutoGenerateColumns="false" CssClass="table table-striped table-bordered table-hover" runat="server">
                                                            ...
                                                            <Columns>
                                                                 <asp:TemplateField>
                                                                    <HeaderTemplate>الاسم</HeaderTemplate>
                                                ...
                                                <asp:HiddenField ID="DocumentTypeIDHiddenField" Value='<%# Eval("DocumentTypeID") %>' runat="server" />
                                                                ...
                                                                <asp:TemplateField>
                                                                    <HeaderTemplate>تحميل الملف</HeaderTemplate>
