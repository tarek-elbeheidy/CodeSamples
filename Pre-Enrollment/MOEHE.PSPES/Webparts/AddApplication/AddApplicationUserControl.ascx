...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AddApplicationUserControl.ascx.cs" Inherits="MOEHE.PSPES.Webparts.AddApplication.AddApplicationUserControl" %>
<section>
                            ...
                            <div class="form-horizontal" id="aspnetForm">
                                <div class="form-wizard">
                                    <div class="form-body pb-0 mb-0">
                                        <ul class="nav nav-pills nav-justified steps">
                                            <li>
                                                <a href="#tab1" data-toggle="tab" style="cursor:default;" class="step">
                                                    <span class="desc">
													<i class="font-icon-detail"><span class="pe-7s-id"></span></i>
                                            ...
                                            <li>
                                                <a href="#tab2" style="cursor:default;" data-toggle="tab" class="step">
                                                    <span class="desc">
                                                        <i class="font-icon-detail"><span class="pe-7s-users"></span></i>
                                            ...
                                            <li>
                                                <a href="#tab3" data-toggle="tab" style="cursor:default;" class="step">
                                                    <span class="desc">
                                                        <i class="font-icon-detail"><span class="pe-7s-note2"></span></i>
                                            ...
                                            <li>
                                                <a href="#tab4" data-toggle="tab" style="cursor:default;" class="step">
                                                    <span class="desc">
                                                        <i class="font-icon-detail"><span class="pe-7s-portfolio"></span></i>
										...
										<div class="call-to-action pt-20 pb-20 mb-20 border-1px bg-lighter">
										  <div class="row">
											<div class="col-xs-12 col-sm-8 col-md-8">
											  <div class="icon-box icon-rounded-bordered left media mb-0 ml-60 ml-sm-0"> <a href="#" class="media-left pull-left flip"> <i class="pe-7s-help2 text-theme-colored border-1px-theme-colored p-20"></i></a>
												<div class="media-body pl-40">
												  <h3 class="media-heading heading">تنويه</h3>
												  <p class=""><asp:Literal runat="server" ID="Literal15" Text='<%$Resources:MOEHE.PSPES,AddApplicationDisclaimer%>'></asp:Literal></p>
												</div>
											  </div>
											</div>
										  </div>
                                                ...
                                                <fieldset class="scheduler-border m-0 mb-5 pb-5 pt-0 col-sm-12">
                                                    ...
                                                    <div class="row m-0">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div id="filterDate2">
                                                                    ...
                                                                    <div class="input-group date" data-date-format="dd/mm/yyyy">
                                                                        <input type="text"  runat="server" onkeydown="return false;" id="dtApplicationDate2" class="form-control ApplicationDate"  placeholder="dd/mm/yyyy">
                                                        ...
                                                        <div class="col-sm-2">
                                                            ...
                                                            <div class="form-group">
                                                                <asp:DropDownList ID="ddlPreEnrollmentTerm" runat="server" CssClass="form-control pt-0">
                                                                </asp:DropDownList>
                                                        ...
                                                        <div class="col-sm-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" id="txtschoolgender" runat="server" class="form-control mb-0"  style="color: #ffffff; background: transparent; border: none; height: 0px!important; width: 0px;">
                                                            </div>
                                                        </div>
                                                        <!--PreEnrollmentGrade-->
                                                        <div class="col-sm-2">
                                                            <div class="form-group">
                                                                ...
                                                                <asp:DropDownList ID="ddlPreEnrolmentGrade" runat="server" CssClass="form-control preenrolmentgrade pt-0" AutoPostBack="True" OnSelectedIndexChanged="ddlPreEnrolmentGrade_SelectedIndexChanged"></asp:DropDownList>
                                                                ...
                                                                <input type="text" id="txtValidGrade" value="0" runat="server" class="isValidGrade form-control mb-0"  style="color: #ffffff; background: transparent; border: none; height: 0px!important; width: 0px;">
                                                            </div>
                                                        </div>
                                                        <!--ResidentialArea-->
                                                        <div class="col-sm-2">
                                                        ...
                                                        <div class="col-sm-2 ">
                                                            <div class="form-group">
                                                                <!--TestResult-->
                                                                <label for="TestResult"><asp:Literal runat="server" ID="Literal14" Text='<%$Resources:MOEHE.PSPES,TransportationRequired%>'></asp:Literal></label>
                                                        ...
                                                        <div class="col-sm-2">
                                                            <div class="form-group">
                                                                <label for="Grade-Vacancy"><asp:Literal runat="server" ID="Literal555" Text='<%$Resources:MOEHE.PSPES,AvailableSeatsInformation%>'></asp:Literal></label>
                                                                <input type="text"  class="form-control" runat="server" id="txtAvailableSeatsInRequestedGrade" Value="" disabled>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-2">
                                                            <div class="form-group">
                                                                <label for="FiltreSchool"> <asp:Literal runat="server" ID="Literal17" Text='<%$Resources:MOEHE.PSPES,WaitListNumber%>'></asp:Literal></label>
                                                ...
                                                <fieldset class="scheduler-border m-0  mb-20 pb-5 pt-0 col-sm-12">
                                                    <legend class="scheduler-border mb-0">
                                                        ...
                                                        <div class="row m-0">
                                                            ...
                                                            <h4 class="line-bottom-theme-colored-2 mt-5 mb-20 ml-20"> <asp:Literal runat="server" ID="Literal45" Text='<%$Resources:MOEHE.PSPES,EmploymentInformation%>'></asp:Literal></h4>
                                                        <div class="row m-0">
                                                ...
                                                <div class="row m-0">
                                                    ...
                                                    <asp:GridView ID="gvParents" runat="server" AutoGenerateColumns="false" CssClass="table table-striped table-bordered table-hover" ShowFooter="false" OnRowDeleting="gvParents_RowDeleting" OnRowEditing="EditParent" OnRowUpdating="UpdateParent" OnDataBound="gvParents_DataBound" OnRowCancelingEdit="CancelEdit" OnRowCommand="gvParents_RowCommand" OnRowDataBound="gvParents_RowDataBound">
                                                        ...
                                                        <Columns>
                                                            <asp:TemplateField>
                                                                <HeaderTemplate>
                                                                    <asp:Literal runat="server" ID="Literal31" Text='<%$Resources:MOEHE.PSPES,QID%>'></asp:Literal></HeaderTemplate>
                                                                <ItemTemplate>
                                                            ...
                                                            <asp:TemplateField>
                                                                <HeaderTemplate>
                                                                    <asp:Literal runat="server" ID="Literal31" Text='<%$Resources:MOEHE.PSPES,Name%>'></asp:Literal></HeaderTemplate>
                                                                <ItemTemplate>
                                                            ...
                                                            <asp:TemplateField>
                                                                <HeaderTemplate>
                                                                    <asp:Literal runat="server" ID="Literal31" Text='<%$Resources:MOEHE.PSPES,Nationality%>'></asp:Literal></HeaderTemplate>
                                                                <ItemTemplate>
                                                            ...
                                                            <asp:TemplateField>
                                                                <HeaderTemplate>
                                                                    <asp:Literal runat="server" ID="Literal31" Text='<%$Resources:MOEHE.PSPES,Relationship%>'></asp:Literal></HeaderTemplate>
                                                                <EditItemTemplate>
                                                            ...
                                                            <asp:TemplateField>
                                                                <HeaderTemplate>
                                                                    <asp:Literal runat="server" ID="Literal31" Text='<%$Resources:MOEHE.PSPES,MobileNumber%>'></asp:Literal></HeaderTemplate>
                                                                <EditItemTemplate>
                                                            ...
                                                            <asp:TemplateField>
                                                                <HeaderTemplate>
                                                                    <asp:Literal runat="server" ID="Literal31" Text='<%$Resources:MOEHE.PSPES,Email%>'></asp:Literal></HeaderTemplate>
                                                                <EditItemTemplate>
                                                    ...
                                                    <div class="row m-0">
                                                        ...
                                                        <div class="col-sm-2">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" id="specialneedValid" class="form-control" name="specialneed" style="color: #ffffff; background: transparent; border: none; height: 0px!important; width: 0px;">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-sm-2">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" id="learningdifficultiesValid" class="form-control" name="learningdifficulties" style="color: #ffffff; background: transparent; border: none; height: 0px!important; width: 0px;">
                                                            </div>
                                                        </div>
                                                        <!--PHCCData-->
                                                        <div class="col-sm-2 ">
                                                            ...
                                                            <div class="col-sm-4">
                                                                <div class="form-group">
                                                                    <div class="sec-filters-item check-item">
                                                                        ...
                                                                        <label for="HealthIssue" class="agree mt-5"><span class="agree">
                                                                            <asp:Literal runat="server" ID="Literal62" Text='<%$Resources:MOEHE.PSPES,PreviousHealthIssues%>'></asp:Literal>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <textarea id="MentionHealthIssues" disabled="true" runat="server" class="form-control health-area textaria-health" rows="4" ></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </fieldset>
                                                ...
                                                <fieldset id="template" class="scheduler-border m-0 mb-5 pb-5 pt-0 col-sm-12">
                                                        ...
                                                        <Columns>
                                                            <asp:TemplateField>
                                                                ...
                                                                <ItemTemplate>
                                                                    ...
                                                                    <asp:HyperLink ID="ArabicDocumentTypeHyperLink" runat="server" Visible='false' Text='<%# Eval("ArabicDocumentType") %>'></asp:HyperLink>
                                                                    <asp:HyperLink ID="EnglishDocumentTypeHyperLink" runat="server" Visible='false' Text='<%# Eval("EnglishDocumentType") %>'></asp:HyperLink>
                                                            ...
                                                            <asp:TemplateField>
                                                                <HeaderTemplate>
                                                                    <asp:Literal runat="server" ID="Literal69" Text='<%$Resources:MOEHE.PSPES,File%>'></asp:Literal></HeaderTemplate>
                                                    ...
                                                    <asp:Panel id="pnlNoRequiredDocuments" runat="server" Visible="false">
                                                        ...
                                                        <div class="alert error-Msgdanger fade in m-0 mb-5 p-10">
                                                            ...
                                                            <div class="glyphicon glyphicon-exclamation-sign m-0"></div><asp:Literal runat="server" ID="Literal1500" Text='<%$Resources:MOEHE.PSPES,NoRequiredDocuments%>'></asp:Literal>
                                                        </div>
                                                    </div>
                                                    </asp:Panel>
                                                </fieldset>
                                    ...
                                    <div class="form-actions mt-0 mb-0 pt-0 pb-0">
                                        <div class="row m-0">
                                            <div class="col-md-12">
												...
												<asp:LinkButton ID="LinkButton1" CssClass="btn btn-default" runat="server" OnClick="LinkButton1_Click" OnClientClick="resetTab()"><i class="fa fa-save mr-10"></i>
                                                    <asp:Literal runat="server" ID="Literal71" Text='<%$Resources:MOEHE.PSPES,Submit%>'></asp:Literal></asp:LinkButton>
												<asp:LinkButton CssClass="btn btn-info" runat="server"  OnClick="LnkCancel_Click" ID="LnkCancel"><i class="fa fa-ban mr-10"></i><asp:Literal runat="server" ID="Literal72" Text='<%$Resources:MOEHE.PSPES,Cancel%>'></asp:Literal></asp:LinkButton>
...
<script>
    $(document).ready(function () {
        ...
        $(".button-next").on("click", function () {
            if ($('.isValidGrade').val() == "0" && $('#preenrolmentgradeValid').val() != "" && $("#ResedentialAreaID").val() != "" && $('#ApplicationDateID').val() != "") {
                var cult = '<%= System.Globalization.CultureInfo.CurrentUICulture.LCID %>';

                if (cult == "1025") {
                    alert("لا يمكن تسجيل الطالب /الطالبة في هذا الصف نظرا لعدم تطابق شرط العمر");
                    return false;
                }
                else {
                    alert("Student application can not be submitted for this grade for violating age restrictions");
                    return false;
                }
            }
