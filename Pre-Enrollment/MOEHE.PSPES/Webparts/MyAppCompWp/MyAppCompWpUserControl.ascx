...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MyAppCompWpUserControl.ascx.cs" Inherits="MOEHE.PSPES.Webparts.MyAppCompWp.MyAppCompWpUserControl" %>
                ...
                <legend style="color: blue; font-weight: bold;">Call for Test </legend>
                    ...
                    <asp:ListItem Text="Rejected" Value="2" ></asp:ListItem>
                     <asp:ListItem Text="No Action Taken" Value="3" Selected="True" ></asp:ListItem>--%>
                         <asp:ListItem Text="<%$Resources:MOEHE.PSPES,CallforTest%>" Value="1" ></asp:ListItem>
                    <asp:ListItem Text="<%$Resources:MOEHE.PSPES,RejectedTest%>" Value="2" ></asp:ListItem>
                     <asp:ListItem Text="<%$Resources:MOEHE.PSPES,noActionTaken%>" Value="3" Selected="True" ></asp:ListItem>
                    </asp:RadioButtonList>
...
<div>
 ...
 <span>Test Result:  <asp:DropDownList ID="DDLTestResult" runat="server" AutoPostBack="true"></asp:DropDownList>
                    ...
                    <br />
                    <asp:GridView ID="gvTestRst" runat="server" AutoGenerateColumns="false">
                        <Columns>
                            <asp:TemplateField>
                                <HeaderTemplate>
                    ...
                    <span>
                      ...
                      <asp:Button ID="btnTestRSTUpload0" runat="server" Text="Upload" OnClick="btnTestRSTUpload_Click" />
                     </span>
                    <br />
                    <span>                  
