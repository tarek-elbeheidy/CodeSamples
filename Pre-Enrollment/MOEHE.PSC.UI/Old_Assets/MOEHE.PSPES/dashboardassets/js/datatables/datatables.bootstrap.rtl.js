...
$.extend(true, $.fn.dataTable.defaults, {
    "dom": "<'tool'<'Show'l><'Search'f>r><'table-scrollable't><'row'<'col-md-5 col-sm-5'i><'col-md-7 col-sm-7'p>>", // default layout with horizobtal scrollable datatable
    //"dom": "<'tools'<'col-md-6 col-sm-12'l><'col-md-6 col-sm-12'f>r>t<'row'<'col-md-5 col-sm-12'i><'col-md-7 col-sm-12'p>>", // datatable layout without  horizobtal scroll(used when bootstrap dropdowns used in the datatable cells)
    "language": {
        "lengthMenu": "إظهار _MENU_ الإدخالات",
        "paginate": {
            "previous": 'Prev',
            "next": 'Next',
            "page": "Page",
