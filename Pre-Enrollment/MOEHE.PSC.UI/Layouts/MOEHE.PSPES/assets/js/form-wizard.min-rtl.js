            ...
            if (jQuery().bootstrapWizard) {
                ...
                r.validate({
                    ...
                    messages: {
						...
						username : {
							minlength: "الرقم الشخصي غير صحيح",
                            required : "الرقم الشخصي مطلوب",
                            maxlength:"الرقم الشخصي غير صحيح"
                        },
                        guardianphone:{
                ...
                var a = function() {
                  ...
                  , o = function(e, r, t) {
                    var i = r.find("li").length
                      , o = t + 1;
                    $(".step-title", $("#form_wizard_1")).text("الخطوة " + (t + 1) + " من " + i),
