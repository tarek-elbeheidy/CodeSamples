...
(function(factory) {
   ...
   ********************/
        ...
        isValidNumber: function() {
            ...
            var getType = intlTelInputUtils.getNumberType(val, countryCode);
            if (getType == 1)
            { return true; }
            else
            { return false; }
            ...
            return window.intlTelInputUtils ? intlTelInputUtils.isValidNumber(val, countryCode).isMobile : null;
        },
