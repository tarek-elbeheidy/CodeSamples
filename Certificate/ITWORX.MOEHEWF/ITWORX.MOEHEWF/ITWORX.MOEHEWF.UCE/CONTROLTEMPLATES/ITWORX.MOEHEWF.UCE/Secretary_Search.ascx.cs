                ...
                using (SPSite site = new SPSite(SPContext.Current.Site.Url))
                {
                    using (SPWeb web = site.OpenWeb())
                    {
                        try
                        {
                            ...
                            {
                                if (LCID == (int)Language.English)
                                    objColumns.Add("AcademicDegreeForEquivalence;Lookup;Eq;" + drp_Certificate.SelectedItem.Text.ToString());
                                else
                                    objColumns.Add("AcademicDegreeForEquivalenceAr;Lookup;Eq;" + drp_Certificate.SelectedItem.Text.ToString());
