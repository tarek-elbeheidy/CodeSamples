...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Procedure_AssistSecretaryListing.ascx.cs" Inherits="ITWORX.MOEHEWF.UCE.CONTROLTEMPLATES.ITWORX.MOEHEWF.UCE.Procedure_AssistSecretaryListing" %>

<div class="row no-padding">
	<asp:LinkButton ID="lnk_AddNewProcedurePopUp" runat="server" Text="<%$Resources:ITWORX_MOEHEWF_UCE, AddNewProcedure %>" OnClick="lnk_AddNewProcedurePopUp_Click" CssClass="btn moe-btn pull-right"/>
