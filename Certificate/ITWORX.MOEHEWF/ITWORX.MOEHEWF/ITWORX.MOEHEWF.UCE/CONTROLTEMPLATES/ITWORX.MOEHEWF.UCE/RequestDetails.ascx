                    ...
                    <asp:Panel ID="pnlDegreeRequiredToBEquivalentData" runat="server">
                        ...
                        <asp:RequiredFieldValidator ID="reqExamLocation" runat="server" ClientIDMode="Static" CssClass="moe-full-width error-msg" ErrorMessage="<%$Resources:ITWORX_MOEHEWF_UCE, RequiredExamLocation %>" ValidationGroup="Submit" ControlToValidate="txtExamLocation" Enabled="false" Display="Dynamic"></asp:RequiredFieldValidator>
                                    ...
                                    <div class="row margin-top-15">
                                        ...
                                        <div class="col-md-4 col-sm-12 col-xs-12 no-padding">
                                            <div class="data-container table-display moe-width-85  ">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form">
                                                        <asp:RadioButtonList ID="radioBtnHavePA" runat="server" ClientIDMode="Static" CssClass="moe-radioBtn"></asp:RadioButtonList>
                                                        <asp:RequiredFieldValidator ID="rfvHavePA" runat="server" CssClass="moe-full-width error-msg" ErrorMessage="<%$Resources:ITWORX_MOEHEWF_UCE, RequiredHavePA %>" ControlToValidate="radioBtnHavePA" ValidationGroup="Submit" Display="Dynamic"></asp:RequiredFieldValidator>
                                        ...
                                        <div id="divlblNoPA" style="display: none" class="col-md-12 col-sm-12 col-xs-12 no-padding">
                                             <h5 class="font-size-18 margin-bottom-0 margin-top-0 instruction-details underline color-black font-family-sans">
                                                <asp:Label ID="lblNoPA" runat="server" Text="<%$Resources:ITWORX_MOEHEWF_UCE, NOHavePAMsg %>"></asp:Label>
                                             </h5>
                                         </div>
                                        </div>
                                        <div class="row margin-top-15" id="YeshavePA" style="display: none">
                                        ...
                                        <div class="row margin-top-15" id="NohavePA" style="display: none">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 col-sm-12 col-xs-12 no-padding">
                                                <div class="data-container table-display moe-width-85  ">
                                                    <div class="form-group">
                                                        <h6 class="font-size-16 margin-bottom-0 margin-top-0">
                                                            <asp:Label ID="Label1" runat="server" Text="<%$Resources:ITWORX_MOEHEWF_UCE, UniversityType %>"></asp:Label>
                                                            <span class="astrik error-msg">*</span>
                                                        </h6>

                                                        <div class="form">
                                                            <asp:RadioButtonList ID="radiobtnlstUniversity" runat="server" ClientIDMode="Static" CssClass="moe-radioBtn"></asp:RadioButtonList>
                                                            <asp:RequiredFieldValidator ID="rfvUniversityType" runat="server" CssClass="moe-full-width error-msg" ErrorMessage="<%$Resources:ITWORX_MOEHEWF_UCE, RequiredUniversityType %>" ControlToValidate="radiobtnlstUniversity" ValidationGroup="Submit" Display="Dynamic"></asp:RequiredFieldValidator>
                                ...
                                <div class="col-md-4 col-sm-12 col-xs-12 no-padding" id="entityNeedsEquivalency" style="display: none">
                                    ...
                                    <div class="data-container table-display moe-width-85  ">
                                        <div class="form-group">
                                            <div class="form">
                                                <div class="uc-dropdown">
                                                    <uc1:DropdownWithTextbox runat="server" id="ddlEntityNeedsEquivalency" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        if ($('#radioBtnHavePA input:checked').val() == "0") {
            $("#NohavePA").show();
            $("#YeshavePA").hide();
            $("#divlblNoPA").show();
        ...
        else if ($('#radioBtnHavePA input:checked').val() == "1") {
        ...
        if ($('#rdbWorkingOrNot input:checked').val() == "0") {
            ...
            // var entityWorkingDrop = $("#entityWorkingFor").find('[id$=reqDropWithNewOption]');
            // ValidatorEnable(document.getElementById(entityWorkingDrop[0].id), true);
            //var entityWorkingText = $("#entityWorkingFor").find('[id$=reqNewOptionText]');
            //ValidatorEnable(document.getElementById(entityWorkingText[0].id), true);

            // var entityNeedsEquivalencyDrop = $("#entityNeedsEquivalency").find('[id$=reqDropWithNewOption]');
            // ValidatorEnable(document.getElementById(entityNeedsEquivalencyDrop[0].id), true);
            //var entityNeedsEquivalencyText = $("#entityNeedsEquivalency").find('[id$=reqNewOptionText]');
            //ValidatorEnable(document.getElementById(entityNeedsEquivalencyText[0].id), true);
        ...
        $("#radioBtnHavePA").change(function () {
            if ($('#radioBtnHavePA input:checked').val() == "0") {
