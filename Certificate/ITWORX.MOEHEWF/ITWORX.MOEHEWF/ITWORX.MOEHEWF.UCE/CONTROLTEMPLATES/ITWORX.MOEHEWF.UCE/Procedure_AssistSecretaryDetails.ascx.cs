...
{
    public partial class Procedure_AssistSecretaryDetails : UserControlBase
    {
        ...
        private void BindProcedure(string ProcID)
        {
            try
            {
                Logging.GetInstance().Debug("Enter Procedure_AssistSecretaryDetails.BindProcedure");
                Entities.Procedures Procedure = BL.AllProcedures.GetProcedurebyID(Utilities.Constants.AssistSecretaryProcedures, ProcID);
                if (Procedure != null)
                {
            ...
            {
                Logging.GetInstance().Debug("Exit Procedure_AssistSecretaryDetails.BindProcedure");
            }
        }
        ...
        protected void btn_Close_Click(object sender, EventArgs e)
        {
            try
            {
                if (!IsRefresh)
                {
                    Logging.GetInstance().Debug("Enter Procedure_AssistSecretaryDetails.btn_Close_Click");

                    Page.Session["hdn_ProcedureId"] = null;
                    // Response.Redirect("/en/Pages/ProceduresAssistSecretaryListing.aspx");
            ...
            finally
            {
                ...
                Logging.GetInstance().Debug("Exit Procedure_AssistSecretaryDetails.btn_Close_Click");
            }
        }
    }
}
