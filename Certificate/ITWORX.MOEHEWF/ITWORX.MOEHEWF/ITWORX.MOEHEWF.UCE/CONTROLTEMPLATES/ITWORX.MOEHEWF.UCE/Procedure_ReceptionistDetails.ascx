...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Procedure_ReceptionistDetails.ascx.cs" Inherits="ITWORX.MOEHEWF.UCE.CONTROLTEMPLATES.ITWORX.MOEHEWF.UCE.Procedure_ReceptionistDetails" %>
