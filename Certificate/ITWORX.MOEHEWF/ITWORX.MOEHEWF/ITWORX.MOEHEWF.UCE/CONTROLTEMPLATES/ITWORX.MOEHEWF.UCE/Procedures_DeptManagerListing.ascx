...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Procedures_DeptManagerListing.ascx.cs" Inherits="ITWORX.MOEHEWF.UCE.CONTROLTEMPLATES.ITWORX.MOEHEWF.UCE.Procedures_DeptManagerListing" %>

<div class="row no-padding">
<asp:LinkButton ID="lnk_AddNewProcedurePopUp" runat="server" Text="<%$Resources:ITWORX_MOEHEWF_UCE, AddNewProcedure %>" 
    OnClick="lnk_AddNewProcedurePopUp_Click" CssClass="btn moe-btn pull-right" Visible="false"/>	
</div>
