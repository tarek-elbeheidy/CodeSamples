...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AssistantUnderSecretaryDecision.ascx.cs" Inherits="ITWORX.MOEHEWF.UCE.CONTROLTEMPLATES.ITWORX.MOEHEWF.UCE.AssistantUnderSecretaryDecision" %>
