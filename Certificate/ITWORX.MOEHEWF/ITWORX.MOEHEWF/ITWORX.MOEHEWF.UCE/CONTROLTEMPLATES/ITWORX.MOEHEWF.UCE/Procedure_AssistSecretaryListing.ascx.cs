    ...
    public partial class Procedure_AssistSecretaryListing : UserControlBase
    {
        ...
        private void BindGrid(string ReqID)
        {
            try
            {
                ...
                List<Entities.Procedures> Procedures = BL.AllProcedures.GetProcedurebyReqID(Utilities.Constants.AssistSecretaryProcedures, ReqID);
        ...
        protected void lnk_View_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (!IsRefresh)
                {
                    ...
                    SPUtility.Redirect(SPContext.Current.Web.Url + "/Pages/ProcedureAssistSecretaryDetails.aspx", SPRedirectFlags.DoNotEndResponse, HttpContext.Current);
                }
            }
            catch (Exception ex)
            {
