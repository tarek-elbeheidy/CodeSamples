...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Procedure_LegalAffairsDetails.ascx.cs" Inherits="ITWORX.MOEHEWF.UCE.CONTROLTEMPLATES.ITWORX.MOEHEWF.UCE.Procedure_LegalAffairsDetails" %>
...
<div class="row unheighlighted-section margin-bottom-20 flex-display flex-wrap">
		...
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="data-container">
				<h6 class="font-size-16 margin-bottom-15">
    <asp:Label ID="lbl_RejectionReason" runat="server" Text="<%$Resources:ITWORX_MOEHEWF_UCE, RejectionReason %>"></asp:Label>
  
				</h6>
				<h5 class="font-size-20">
    <asp:Label ID="lbl_RejectionReasonVal" runat="server"></asp:Label>
