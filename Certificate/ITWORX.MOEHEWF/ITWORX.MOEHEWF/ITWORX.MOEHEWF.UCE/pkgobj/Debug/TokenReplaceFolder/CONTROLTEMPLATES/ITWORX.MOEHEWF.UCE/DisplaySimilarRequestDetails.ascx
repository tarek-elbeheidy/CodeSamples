...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DisplaySimilarRequestDetails.ascx.cs" Inherits="ITWORX.MOEHEWF.UCE.CONTROLTEMPLATES.ITWORX.MOEHEWF.UCE.DisplaySimilarRequestDetails" %>
...
<div id="divformControls" runat="server">
	...
	<div id="divRequestDetails" class="row heighlighted-section margin-bottom-50 flex-display flex-wrap test-display margin-0">
						...
						<div class="accordion-inner">
							...
							<div id="divCertificatesData" class="display-mode">
								...
								<div class="row margin-top-15">
                                    ...
                                    <div class="col-md-4 col-sm-6 no-padding" id="entityProviding" style="display: none">
										<div class="data-container table-display moe-width-85  moe-sm-full-width">
											<div class="form-group">
												<h6 class="font-size-16 margin-bottom-0 margin-top-0">
...
<%--
							...
							<div id="divUniversitiesDetails" class="display-mode">
								<div class="row margin-top-15">
											...
											<div class="form-group">
												<h6 class="font-size-16 margin-bottom-0 margin-top-0">
													<asp:Label ID="lblCountries" runat="server" Text="<%$Resources:ITWORX_MOEHEWF_UCE, CountryOfStudy %>" Font-Bold="true"></asp:Label>
                                                     <asp:Label ID="lblNewCoutriesAdded" runat="server" Visible="false" Text="<%$Resources:ITWORX_MOEHEWF_UCE, NewCountryAdded %>"/>
											...
											<div class="form-group">
												<h6 class="font-size-16 margin-bottom-0 margin-top-0">
													<asp:Label ID="lblUniversity" runat="server" Font-Bold="true" Text="<%$Resources:ITWORX_MOEHEWF_UCE, University %>"></asp:Label>
                                                      <asp:Label ID="lblNewUniversitiesAdded" runat="server" Visible="false" Text="<%$Resources:ITWORX_MOEHEWF_UCE, NewUniversityAdded %>"/>
												</h6>
												<h5 class="font-size-20 margin-bottom-0 margin-top-0">
									...
									<div class="col-md-4 col-sm-6 no-padding test">
										<div class="data-container table-display moe-width-85  moe-sm-full-width">
											<div class="form-group">
												<h6 class="font-size-16 margin-bottom-0 margin-top-0">
											...
											<div class="form-group">
												<h6 class="font-size-16 margin-bottom-0 margin-top-0">
													<asp:Label ID="lblUniversityMainHeadQuarter" runat="server" Font-Bold="true" Text="<%$Resources:ITWORX_MOEHEWF_UCE, UniversityMainHeadquarter %>"></asp:Label>
                                                      <asp:Label ID="lblUniversityMainAdded" runat="server" Visible="false" Text="<%$Resources:ITWORX_MOEHEWF_UCE, NewUniversityMainAdded %>"/>
				...
				<asp:Panel ID="pnlWorkingDetails" runat="server">
					...
					<div id="divWorkingDetails" class="display-mode">
						<div class="row margin-top-15">
							...
							<div class="col-md-4 col-sm-6 no-padding" id="workEntityNeedsEquivalency" runat="server" visible="false">
				...
				<div class="form-group">
					...
					<h5 class="font-size-20  margin-bottom-0 margin-top-0">
						...
						<asp:Label ID="lblOtherEntityNeedsEquivalencyValue" runat="server" Visible="false"></asp:Label>
							...
							<div class="col-md-12 col-sm-12 col-xs-12 no-padding test-file"  id="fileWorkig">
								<div class="data-container table-display moe-width-85">
									<div class="form-group">
										<h6 class="font-size-16 margin-bottom-0 margin-top-0">
                              ...
                              <div class="col-md-12 col-sm-12 col-xs-12 no-padding margin-top-15" id="filenotWorking"  >
