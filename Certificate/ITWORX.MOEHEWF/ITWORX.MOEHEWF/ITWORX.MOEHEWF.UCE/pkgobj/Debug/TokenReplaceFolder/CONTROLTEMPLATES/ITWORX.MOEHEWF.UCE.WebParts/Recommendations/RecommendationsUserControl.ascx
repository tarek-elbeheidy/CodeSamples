...
<%@ Register Src="~/_controltemplates/15/ITWORX.MOEHEWF.UCE/ProgramManagerRecommendation.ascx" TagPrefix="uc1" TagName="ProgramManagerRecommendation" %>
...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="RecommendationsUserControl.ascx.cs" Inherits="ITWORX.MOEHEWF.UCE.WebParts.Recommendations.RecommendationsUserControl" %>
