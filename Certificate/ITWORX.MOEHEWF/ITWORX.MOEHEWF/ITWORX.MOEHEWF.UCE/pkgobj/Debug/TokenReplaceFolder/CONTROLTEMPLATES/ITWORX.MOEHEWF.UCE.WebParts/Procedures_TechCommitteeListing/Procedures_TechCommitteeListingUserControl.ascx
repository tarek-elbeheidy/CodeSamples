...
<%@ Register Src="~/_controltemplates/15/ITWORX.MOEHEWF.UCE/Procedure_TechCommitteListing.ascx" TagPrefix="uc1" TagName="Procedure_TechCommitteListing" %>
...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Procedures_TechCommitteeListingUserControl.ascx.cs" Inherits="ITWORX.MOEHEWF.UCE.WebParts.Procedures_TechCommitteeListing.Procedures_TechCommitteeListingUserControl" %>
