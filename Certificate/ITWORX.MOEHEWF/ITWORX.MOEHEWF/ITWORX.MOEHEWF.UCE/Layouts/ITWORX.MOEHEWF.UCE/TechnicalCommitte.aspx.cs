...
{
    public partial class TechnicalCommitte : LayoutsPageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Session["ActionTaken"] != null)
            {
                if (Session["ActionTaken"].ToString() == "AddNewProcedure")
                    LastLoadedControl = BASE_PATH + "Add_TechCommitteeProcedure.ascx";

                else if (Session["ActionTaken"].ToString() == "AddNewTechDecision")
