...
<%@ Register Src="~/_controltemplates/15/ITWORX.MOEHEWF.UCE/ExternalCommListing.ascx" TagPrefix="uc1" TagName="ExternalCommListing" %>
...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ExternalCommunicationsUserControl.ascx.cs" Inherits="ITWORX.MOEHEWF.UCE.WebParts.ExternalCommunications.ExternalCommunicationsUserControl" %>
