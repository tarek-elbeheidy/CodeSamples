...
<%@ Register Src="~/_controltemplates/15/ITWORX.MOEHEWF.UCE/HistoricalRecords.ascx" TagPrefix="uc1" TagName="HistoricalRecords" %>
...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="HistoricalRecordsUserControl.ascx.cs" Inherits="ITWORX.MOEHEWF.UCE.WebParts.HistoricalRecords.HistoricalRecordsUserControl" %>
...
<div class="row section-container side-nav-container">
    ...
    <div class="col-md-9 col-xs-12 no-padding test">
        <!-- required for floating -->
       <uc1:HistoricalRecords runat="server" id="HistoricalRecords" />
    </div>
