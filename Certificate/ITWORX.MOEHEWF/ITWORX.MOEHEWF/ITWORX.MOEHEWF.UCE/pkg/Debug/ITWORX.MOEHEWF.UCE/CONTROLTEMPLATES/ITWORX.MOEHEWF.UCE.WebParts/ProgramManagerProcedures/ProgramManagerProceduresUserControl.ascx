...
<%@ Register Src="~/_controltemplates/15/ITWORX.MOEHEWF.UCE/Procedures_ProgramManager.ascx" TagPrefix="uc1" TagName="Procedures_ProgramManager" %>
...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ProgramManagerProceduresUserControl.ascx.cs" Inherits="ITWORX.MOEHEWF.UCE.WebParts.ProgramManagerProcedures.ProgramManagerProceduresUserControl" %>
