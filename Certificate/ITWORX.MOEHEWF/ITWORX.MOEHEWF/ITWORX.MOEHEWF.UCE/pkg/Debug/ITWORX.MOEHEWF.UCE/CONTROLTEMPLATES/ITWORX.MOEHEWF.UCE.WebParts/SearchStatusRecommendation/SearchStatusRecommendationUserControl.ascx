...
<%@ Register Src="~/_controltemplates/15/ITWORX.MOEHEWF.UCE/SearchStatusRecommendationUC.ascx" TagPrefix="uc1" TagName="SearchStatusRecommendationUC" %>


<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SearchStatusRecommendationUserControl.ascx.cs" Inherits="ITWORX.MOEHEWF.UCE.WebParts.SearchStatusRecommendation.SearchStatusRecommendationUserControl" %>
