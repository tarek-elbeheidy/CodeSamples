...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DisplayApplicantDetails.ascx.cs" Inherits="ITWORX.MOEHEWF.UCE.CONTROLTEMPLATES.ITWORX.MOEHEWF.UCE.DisplayApplicantDetails" %>
...
<div id="applicantDetails">
	...
	<div class="cotainer heighlighted-section margin-bottom-10">
		<div class="row">
		...
		<div class="col-md-4 col-sm-6 auto-height">
			<div class="data-container no-margin-imp">
				...
				<h5 class="font-size-20" title="applicanta@moehe.gov.qa">
	...
	<div class="row unheighlighted-section margin-0">
		...
		<div class="col-md-7 col-sm-12 col-xs-12 margin-top-15">
			<div class="data-container">
