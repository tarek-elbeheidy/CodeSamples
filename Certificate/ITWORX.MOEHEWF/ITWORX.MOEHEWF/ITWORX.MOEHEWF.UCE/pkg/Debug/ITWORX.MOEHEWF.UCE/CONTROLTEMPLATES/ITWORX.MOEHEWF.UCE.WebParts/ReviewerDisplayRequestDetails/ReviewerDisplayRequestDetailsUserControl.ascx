...
<%@ Register Src="~/_controltemplates/15/ITWORX.MOEHEWF.UCE/ReviewerDisplayRequestDetails.ascx" TagPrefix="uc1" TagName="ReviewerDisplayRequestDetails" %>
...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ReviewerDisplayRequestDetailsUserControl.ascx.cs" Inherits="ITWORX.MOEHEWF.UCE.WebParts.ReviewerDisplayRequestDetails.ReviewerDisplayRequestDetailsUserControl" %>
...
<div class="row section-container side-nav-container">
   ...
   <div class="col-md-9 col-xs-12 no-padding test">
        ...
        <uc1:ReviewerDisplayRequestDetails runat="server" id="ReviewerDisplayRequestDetails" />
    </div>
</div>
