...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ViewTechCommitteeDec_AllDecision.ascx.cs" Inherits="ITWORX.MOEHEWF.UCE.CONTROLTEMPLATES.ITWORX.MOEHEWF.UCE.ViewTechCommitteeDec_AllDecision" %>
...
<div class="row no-padding margin-top-15">
	<h5 class="col-md-12 font-size-18 font-weight-600 text-center">
