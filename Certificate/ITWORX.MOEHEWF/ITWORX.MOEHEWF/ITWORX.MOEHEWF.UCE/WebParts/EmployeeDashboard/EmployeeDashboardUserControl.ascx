...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EmployeeDashboardUserControl.ascx.cs" Inherits="ITWORX.MOEHEWF.UCE.WebParts.EmployeeDashboard.EmployeeDashboardUserControl" %>

<div class="section-container">
       <div class="row">
           <div class="col-md-7 col-xs-12">
               <h1 class=" section-title font-weight-600 no-margin margin-top-0" style="margin-bottom:30px;font-size: calc(.6em + 0.95vw);">
           ...
           <div class="col-md-5 col-xs-12 text-right">
                           <asp:HyperLink ID="hprLnkPriorApproval" runat="server"  CssClass="btn moe-btn"><asp:Literal runat="server"  Text="<%$Resources:ITWORX.MOEHEWF.Common, BackToHome %>" /></asp:HyperLink>
...
<div class="row  margin-bottom-25">
     <asp:Menu ID="Menu_ParentLinks" runat="server" OnMenuItemClick="Menu_ParentLinks_MenuItemClick" Orientation="Horizontal">
            <Items>
                <asp:MenuItem Text="<%$Resources:ITWORX_MOEHEWF_UCE, MyRequests %>" Value="0"></asp:MenuItem>
                <asp:MenuItem Text="<%$Resources:ITWORX_MOEHEWF_UCE, Search %>" Value="1"></asp:MenuItem>
            </Items>
        </asp:Menu>
      
<%--      <asp:PlaceHolder ID="PlaceHolder_RequestsChart" runat="server"></asp:PlaceHolder>--%>
