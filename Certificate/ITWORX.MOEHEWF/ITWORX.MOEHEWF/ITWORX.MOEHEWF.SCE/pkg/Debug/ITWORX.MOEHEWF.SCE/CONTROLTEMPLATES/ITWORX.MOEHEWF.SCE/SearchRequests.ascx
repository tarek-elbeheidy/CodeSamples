...
<div id="SrchControls">
    <div class="row no-padding heighlighted-section margin-bottom-50 flex-display flex-wrap">
            ...
            <div class="data-container table-display">
                <div class="form-group">
                    <h6 class="font-size-16 margin-bottom-10 margin-top-10">
                        <asp:Label ID="lbl_RequestID" runat="server" Text="<%$Resources:ITWORX_MOEHEWF_SCE, RequestID %>"></asp:Label>
                    ...
                    <div class="form">
                        ...
                        <asp:RegularExpressionValidator ID="regVal_NumbersOnly" ControlToValidate="txt_RequestID" ValidationExpression="^[a-zA-Z0-9_.-]*$" ValidationGroup="Srch"
                            Display="Static" EnableClientScript="true" ErrorMessage="<%$Resources:ITWORX_MOEHEWF_SCE, NumbersaAndAlphaOnly %>" runat="server" CssClass="error-msg moe-full-width" />
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 no-padding">
            <div class="data-container table-display  ">
                <div class="form-group">
                    <h6 class="font-size-16 margin-bottom-10 margin-top-10">
                        <asp:Label ID="lbl_NationalID" runat="server" Text="<%$Resources:ITWORX_MOEHEWF_SCE, QatariID %>"></asp:Label>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 no-padding">
            <div class="data-container table-display  ">
                <div class="form-group">
                    <h6 class="font-size-16 margin-bottom-10 margin-top-10">
                        <asp:Label ID="lbl_ApplicantName" runat="server" Text="<%$Resources:ITWORX_MOEHEWF_SCE, ApplicantName %>"></asp:Label>
                    </h6>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 no-padding">
            <div class="data-container table-display  ">
                <div class="form-group">
                    <h6 class="font-size-16 margin-bottom-10 margin-top-10">
                        <asp:Label ID="lbl_DateFrom" runat="server" Text="<%$Resources:ITWORX_MOEHEWF_SCE, SubmitDateFrom %>"></asp:Label>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 no-padding">
            <div class="data-container table-display  ">
                <div class="form-group">
                    <h6 class="font-size-16 margin-bottom-10 margin-top-10">
                        <asp:Label ID="lbl_DateTo" runat="server" Text="<%$Resources:ITWORX_MOEHEWF_SCE, SubmitDateTo %> "></asp:Label>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 no-padding">
            <div class="data-container table-display  ">
                <div class="form-group">
                    <h6 class="font-size-16 margin-bottom-10 margin-top-10">
                        <asp:Label ID="lbl_NationCategory" runat="server" Text="<%$Resources:ITWORX_MOEHEWF_SCE, NationalityCategory %> "></asp:Label>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 no-padding">
            <div class="data-container table-display  ">
                <div class="form-group">
                    <h6 class="font-size-16 margin-bottom-10 margin-top-10">
                        <asp:Label ID="lbl_Certificate" runat="server" Text="<%$Resources:ITWORX_MOEHEWF_SCE, Certificate %>"></asp:Label>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 no-padding">
            <div class="data-container table-display  ">
                <div class="form-group">
                    <h6 class="font-size-16 margin-bottom-10 margin-top-10">
                        <asp:Label ID="lbl_Country" runat="server" Text="<%$Resources:ITWORX_MOEHEWF_SCE, Country %> "></asp:Label>

                    </h6>

                    <div class="form">
                        <asp:DropDownList ID="drp_Country" runat="server" CssClass="moe-dropdown moe-full-width moe-input-padding moe-select input-height-42" OnSelectedIndexChanged="drp_Country_SelectedIndexChanged" AutoPostBack="true" EnableViewState="false">
                        </asp:DropDownList>
            ...
            <div class="data-container table-display  ">
                <div class="form-group">
                    ...
                    <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <h6 class="font-size-16 margin-bottom-10 margin-top-10">
                                <asp:Label ID="lbl_University" runat="server" Text="<%$Resources:ITWORX_MOEHEWF_SCE, UniversityName %>"></asp:Label>
                            </h6>
                            <div class="form">
                                <asp:DropDownList ID="drp_University" runat="server" AutoPostBack="false" CssClass="moe-dropdown moe-full-width moe-input-padding moe-select input-height-42"></asp:DropDownList>
                            </div>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 no-padding">
            ...
            <div class="data-container table-display  ">
                <div class="form-group">
                      <h6 class="font-size-16 margin-bottom-10 margin-top-10">
                        <asp:Label ID="facultylbl" runat="server" Text="<%$Resources:ITWORX_MOEHEWF_SCE, FacultyName %>"></asp:Label>
                    </h6>
            ...
            <div class="data-container table-display  ">
                <div class="form-group">
                    ...
                    <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <h6 class="font-size-16 margin-bottom-10 margin-top-10">
                                <asp:Label ID="lbl_Specialization" runat="server" Text="<%$Resources:ITWORX_MOEHEWF_SCE, Specialization %> "></asp:Label>
                            </h6>
                            <div class="form">
            ...
            <div class="data-container table-display  ">
                <div class="form-group">
                    <h6 class="font-size-16 margin-bottom-10 margin-top-10">
                        ...
                        <asp:Label ID="lbl_EntityNeedsEquivalency" runat="server" Text="<%$Resources:ITWORX_MOEHEWF_SCE, EntityNeedsEquivalency %> "></asp:Label>
            ...
            <div class="data-container table-display  ">
                <div class="form-group">
                    <h6 class="font-size-16 margin-bottom-10 margin-top-10">
                        ...
                        <asp:Label ID="lbl_Employee" runat="server" Text="<%$Resources:ITWORX_MOEHEWF_SCE, Employee %>"></asp:Label>
        ...
        <div class="col-md-12 col-sm-12 col-xs-12  col-xs-12 no-padding">
            ...
            <asp:Button ID="btnExportExcel" runat="server" Text="<%$Resources:ITWORX.MOEHEWF.Common, ExportExcel %>" OnClick="btnExportExcel_Click" OnClientClick="return setFormSubmitToFalse();" ClientIDMode="Static" CssClass="btn moe-btn pull-right margin-right-10" />
        </div>
    ...
    <cc1:ModalPopupExtender ID="modalSearchFilter" runat="server"
                ...
                PopupControlID="pnlFilter" BackgroundCssClass="modalBackground"></cc1:ModalPopupExtender>
     ...
     <asp:Label ID="lblFilterMsg" runat="server" ForeColor="Green" Font-Bold="true"  Text="<%$Resources:ITWORX.MOEHEWF.Common, SearchFilterMsg %>" ></asp:Label>
                ...
                <asp:Button ID="btnOk" runat="server" Text="<%$Resources:ITWORX_MOEHEWF_SCE, Ok %>" OnClick="btnOk_Click" />    
...
<asp:GridView ID="grd_Requests" runat="server" AutoGenerateColumns="false" AllowPaging="true" DataKeyNames="ID"
    ...
    <Columns>
        ...
        <asp:TemplateField HeaderText="<%$Resources:ITWORX_MOEHEWF_SCE, CountryName %>">
            <ItemTemplate>
        ...
        <asp:TemplateField HeaderText="<%$Resources:ITWORX_MOEHEWF_SCE, responsibleOfficer %>">
            <ItemTemplate>
