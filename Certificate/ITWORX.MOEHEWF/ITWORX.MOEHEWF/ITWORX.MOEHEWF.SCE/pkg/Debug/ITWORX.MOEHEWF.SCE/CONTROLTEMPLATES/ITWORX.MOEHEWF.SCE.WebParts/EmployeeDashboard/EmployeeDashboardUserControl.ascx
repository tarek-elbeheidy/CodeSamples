...
<div class="section-container">
    ...
    <div class="row margin-bottom-0 ">
        ...
        <div class="col-md-5 col-xs-12 text-right">
                    <asp:HyperLink ID="hprLnkEquivalence" runat="server" CssClass="moe-btn btn"><asp:Literal runat="server" Text="<%$Resources:ITWORX_MOEHEWF_SCE, BackHome %>" /></asp:HyperLink>
