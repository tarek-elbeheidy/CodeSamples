...
{
    public partial class SCEBookReplyUserControl : UserControlBase
    {
        public int? BookId
        {
            get
                ...
                SPSecurity.RunWithElevatedPrivileges(() =>
                {
                    ...
                    using (SCEContextDataContext ctx = new SCEContextDataContext(rootWebUrl))
                    {
                        ...
                        if (bookRequest != null)
                        {
                            ...
                            txtAuthority.Text = bookRequest.BookEntityTitle ?? string.Empty;
                        }
                    }
                });
            }
                            ...
                            using (SCEContextDataContext ctx = new SCEContextDataContext(rootWebUrl))
                            {
                                try
                                {
                                    ...
                                    if (bookRequest != null)
                                    {
                                        ...
                                        bookRequest.ReplyDate = txtReplyDate.Text;
