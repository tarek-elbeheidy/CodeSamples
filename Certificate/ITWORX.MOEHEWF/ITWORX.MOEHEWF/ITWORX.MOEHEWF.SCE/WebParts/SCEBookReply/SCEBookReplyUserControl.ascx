...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SCEBookReplyUserControl.ascx.cs" Inherits="ITWORX.MOEHEWF.SCE.WebParts.SCEBookReply.SCEBookReplyUserControl" %>
