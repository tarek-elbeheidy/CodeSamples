...
{
    public partial class PAReturnedRequests : UserControlBase
    {
        #region Public Properties
        public string SPGroupName { get; set; }
        #endregion
        protected void Page_Load(object sender, EventArgs e)
        { var hdnCtl = Page.Request.Form.Get("__EventTriggerControlIdReturn");
        ...
        protected void grd_ReturnedRequests_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            try
            {
                Logging.GetInstance().Debug("Enter RejectedRequests.grd_PANewRequests_RowDataBound");
            ...
            {
                Logging.GetInstance().Debug("Exit RejectedRequests.grd_PANewRequests_RowDataBound");
            }
        }
