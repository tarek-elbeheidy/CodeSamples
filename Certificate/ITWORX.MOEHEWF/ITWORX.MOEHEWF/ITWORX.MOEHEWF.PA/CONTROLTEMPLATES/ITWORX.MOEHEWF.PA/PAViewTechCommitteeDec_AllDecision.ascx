...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PAViewTechCommitteeDec_AllDecision.ascx.cs" Inherits="ITWORX.MOEHEWF.PA.CONTROLTEMPLATES.ITWORX.MOEHEWF.PA.ViewTechCommitteeDec_AllDecision" %>
