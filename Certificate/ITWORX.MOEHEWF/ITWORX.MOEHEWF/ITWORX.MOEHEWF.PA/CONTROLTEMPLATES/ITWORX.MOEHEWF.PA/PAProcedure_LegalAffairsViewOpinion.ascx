...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PAProcedure_LegalAffairsViewOpinion.ascx.cs" Inherits="ITWORX.MOEHEWF.PA.CONTROLTEMPLATES.ITWORX.MOEHEWF.PA.Procedure_LegalAffairsViewOpinion" %>
...
<div class="col-md-12 col-sm-12 col-xs-12">
	<div class="data-container">
		<h6 class="font-size-16 margin-bottom-10">
