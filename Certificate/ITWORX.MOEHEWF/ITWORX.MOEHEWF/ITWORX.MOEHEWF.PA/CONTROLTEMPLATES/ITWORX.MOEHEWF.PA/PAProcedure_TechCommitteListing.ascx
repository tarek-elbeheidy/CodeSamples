...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PAProcedure_TechCommitteListing.ascx.cs" Inherits="ITWORX.MOEHEWF.PA.CONTROLTEMPLATES.ITWORX.MOEHEWF.PA.Procedure_TechCommitteListing" %>
