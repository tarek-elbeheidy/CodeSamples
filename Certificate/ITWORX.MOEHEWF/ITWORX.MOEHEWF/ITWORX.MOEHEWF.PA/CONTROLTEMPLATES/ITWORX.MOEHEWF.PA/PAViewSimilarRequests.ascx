...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PAViewSimilarRequests.ascx.cs" Inherits="ITWORX.MOEHEWF.PA.CONTROLTEMPLATES.ITWORX.MOEHEWF.PA.PAViewSimilarRequests" %>
