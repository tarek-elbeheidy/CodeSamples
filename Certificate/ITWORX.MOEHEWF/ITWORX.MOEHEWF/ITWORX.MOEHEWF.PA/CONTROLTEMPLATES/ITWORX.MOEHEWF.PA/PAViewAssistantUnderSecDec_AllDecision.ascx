...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PAViewAssistantUnderSecDec_AllDecision.ascx.cs" Inherits="ITWORX.MOEHEWF.PA.CONTROLTEMPLATES.ITWORX.MOEHEWF.PA.ViewAssistantUnderSecDec_AllDecision" %>
