...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PAProcedure_ReceptionistDetails.ascx.cs" Inherits="ITWORX.MOEHEWF.PA.CONTROLTEMPLATES.ITWORX.MOEHEWF.PA.Procedure_ReceptionistDetails" %>
...
<div class="row heighlighted-section margin-bottom-50 flex-display flex-wrap">
    ...
    <div class="col-md-12 no-padding margin-top-25">
