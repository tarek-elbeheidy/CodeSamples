...
{
    public partial class PAProcedure_DeptManagerDetails : UserControlBase
    {
        ...
        private void BindProcedure(string ProcID)
        {
            try
            {
                Logging.GetInstance().Debug("Enter PAProcedure_DeptManagerDetails.BindProcedure");
                Entities.Procedures Procedure = BL.AllProcedures.GetProcedurebyID(Utilities.Constants.PADepartmentManagerProcedures, ProcID);
                if (Procedure != null)
                {
            ...
            {
                Logging.GetInstance().Debug("Exit PAProcedure_DeptManagerDetails.BindProcedure");
            }
        }
        ...
        protected void btn_Close_Click(object sender, EventArgs e)
        {
            try
            {
                if (!IsRefresh)
                {
                    Logging.GetInstance().Debug("Enter PAProcedure_DeptManagerDetails.btn_Close_Click");

                    Page.Session["hdn_ProcedureId"] = null;
                    //Response.Redirect("/en/Pages/PAProceduresDeptManagerListing.aspx");
            ...
            {
                Logging.GetInstance().Debug("Exit PAProcedure_DeptManagerDetails.btn_Close_Click");
            }
        }
    }
}