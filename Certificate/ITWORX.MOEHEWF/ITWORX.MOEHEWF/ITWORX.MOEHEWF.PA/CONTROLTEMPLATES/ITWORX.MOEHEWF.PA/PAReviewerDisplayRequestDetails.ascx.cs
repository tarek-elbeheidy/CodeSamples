...
{
    public partial class PAReviewerDisplayRequestDetails : UserControlBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                { 
                    bool userInGroup = HelperMethods.InGroup(Common.Utilities.Constants.ArabicProgEmployeeGroupName);
        ...
        private void PADisplayRequestData()
        {
            ...
            try
            {
                ...
                if (requestItem != null)
                {
                    ...
                    //Removed from View
                    if (requestItem.ProgramUniversity!=null &&  string.IsNullOrEmpty(requestItem.ProgramUniversity.SelectedID))
                    {
                    ...
                    lblUniversityListValue.Text = requestItem.UniversityList != null ? requestItem.UniversityList : "N/A";
                    ...
                    if (requestItem.ProgramCountry != null &&  string.IsNullOrEmpty(requestItem.ProgramCountry.SelectedID))
                    {
