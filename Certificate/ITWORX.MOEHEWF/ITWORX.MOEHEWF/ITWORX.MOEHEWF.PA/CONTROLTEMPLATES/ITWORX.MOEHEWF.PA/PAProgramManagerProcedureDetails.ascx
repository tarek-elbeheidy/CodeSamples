...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PAProgramManagerProcedureDetails.ascx.cs" Inherits="ITWORX.MOEHEWF.PA.CONTROLTEMPLATES.ITWORX.MOEHEWF.PA.ProgramManagerProcedureDetails" %>
    ...
    <div class="col-md-3 col-sm-6">
            <div class="data-container">
                <h6 class="font-size-16 margin-bottom-15">
                      ...
                      <asp:Label ID="lbl_ProcedureDate" runat="server" Text="<%$Resources:ITWORX_MOEHEWF_PA, ProcedureDate %>"></asp:Label>
...
<div class="row unheighlighted-section margin-bottom-50 flex-display flex-wrap">
    <div class="col-md-3 col-sm-6">
            <div class="data-container">
                <h6 class="font-size-16 margin-bottom-15">
                    ...
                    <asp:Label ID="lbl_ProcedureComments" runat="server" Text="<%$Resources:ITWORX_MOEHEWF_PA, ProcedureComments %>"></asp:Label>
    ...
    <div class="col-md-3 col-sm-6">
     ...
     <div class="col-md-3 col-sm-6">
            <div class="data-container">
                <h6 class="font-size-16 margin-bottom-15">
                    <asp:Label ID="lbl_EmpAssignedTo" runat="server" Text="<%$Resources:ITWORX_MOEHEWF_PA, AssignToEmpName %>"></asp:Label>
   ...
   <asp:Label ID="lbl_ProcedureCreatedBy" runat="server" Text=" <%$Resources:ITWORX_MOEHEWF_PA, ProcedureCreatedBy %>"></asp:Label>
