...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PAProcedure_AssistSecretaryListing.ascx.cs" Inherits="ITWORX.MOEHEWF.PA.CONTROLTEMPLATES.ITWORX.MOEHEWF.PA.Procedure_AssistSecretaryListing" %>

<div class="row">
    <asp:LinkButton ID="lnk_AddNewProcedurePopUp" runat="server" Text="<%$Resources:ITWORX_MOEHEWF_PA, AddNewProcedure %>" OnClick="lnk_AddNewProcedurePopUp_Click" CssClass="moe-btn btn pull-right"/>
</div>
