...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PATechCommitteeViewDecision.ascx.cs" Inherits="ITWORX.MOEHEWF.PA.CONTROLTEMPLATES.ITWORX.MOEHEWF.PA.TechCommitteeViewDecision" %>
...
<div class="row heighlighted-section margin-bottom-50 flex-display flex-wrap">
	<div class="col-md-12 no-padding margin-bottom-20">
		<asp:LinkButton ID="lnk_AddNewDecisionPopUp" runat="server" Text="<%$Resources:ITWORX_MOEHEWF_UCE, ApproveDecision %>" OnClick="lnk_AddNewDecisionPopUp_Click" />
