...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PAUploadUC.ascx.cs" Inherits="ITWORX.MOEHEWF.PA.CONTROLTEMPLATES.ITWORX.MOEHEWF.PA.UploadUC" %>


<asp:Panel ID="pnl_Files" runat="server" Text="<%$Resources:ITWORX_MOEHEWF_PA, FilesUploaded %>">
    <asp:Label ID="lbl_FileName" runat="server" Text="<%$Resources:ITWORX_MOEHEWF_PA, FileName %>"></asp:Label>
    <asp:FileUpload ID="uploadFile" runat="server" />
    <asp:Button ID="btn_Upload" runat="server" OnClick="btn_Upload_Click" Text="<%$Resources:ITWORX_MOEHEWF_PA, Upload %>" />
    <asp:Label ID="lbl_msgNotFound" runat="server" Text="<%$Resources:ITWORX_MOEHEWF_PA, FileMsgNotFound %>"></asp:Label>
