...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PAExternalCommDetails.ascx.cs" Inherits="ITWORX.MOEHEWF.PA.CONTROLTEMPLATES.ITWORX.MOEHEWF.PA.PAExternalCommDetails" %>
...
<div class="section-container panel_main_title">
	<asp:Panel ID="pnl_SubmitOrgReply" runat="server" GroupingText="<%$Resources:ITWORX_MOEHEWF_UCE, SubmitEntityReply %>" CssClass="stateTitle">
		<div>
			<asp:Panel ID="pnl_BookDetails" runat="server" GroupingText="<%$Resources:ITWORX_MOEHEWF_UCE, BookDetails %>" CssClass="row no-padding heighlighted-section flex-display flex-wrap margin-bottom-25 field_width">
				...
				<div class="col-md-3 col-sm-6">
					<div class="data-container">
						...
						<h5 class="font-size-22">
							<asp:Label ID="lbl_OrgAddressVal" runat="server" TextMode="MultiLine"></asp:Label>
						</h5>
					</div>
				</div>
				<div class="col-md-3 col-sm-6">
			...
			<asp:Panel ID="pnl_OrgReply" runat="server" GroupingText="<%$Resources:ITWORX_MOEHEWF_UCE, EntityReply %>" CssClass="row no-padding unheighlighted-section flex-display flex-wrap margin-bottom-25 field_width">
				<div class="col-md-3 col-sm-6">
					<div class="data-container">
						<h6 class="font-size-16 margin-bottom-15">
				...
				<div class="col-md-12 no-padding margin-top25 text-right">
