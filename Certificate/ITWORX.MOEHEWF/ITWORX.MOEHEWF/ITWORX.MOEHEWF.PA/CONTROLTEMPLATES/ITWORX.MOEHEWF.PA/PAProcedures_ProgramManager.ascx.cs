    ...
    public partial class Procedures_ProgramManager : UserControlBase
    {
        ...
        private void BindGrid(string ReqID)
        {
            try
            {
                ...
                List<Entities.Procedures> Procedures = BL.AllProcedures.GetProgManagerProceduresbyReqID(Utilities.Constants.PAProgramManagerProcedures, ReqID,false);
        ...
        protected void lnk_View_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (!IsRefresh)
                {
                    ...
                    SPUtility.Redirect(SPContext.Current.Web.Url + "/Pages/PAProgramManagerProcDetails.aspx", SPRedirectFlags.DoNotEndResponse, HttpContext.Current);
                }
            }
            catch (Exception ex)
            {
