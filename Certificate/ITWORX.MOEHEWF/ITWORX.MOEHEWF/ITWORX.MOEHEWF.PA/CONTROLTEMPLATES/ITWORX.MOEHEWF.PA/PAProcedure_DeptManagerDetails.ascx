...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PAProcedure_DeptManagerDetails.ascx.cs" Inherits="ITWORX.MOEHEWF.PA.CONTROLTEMPLATES.ITWORX.MOEHEWF.PA.PAProcedure_DeptManagerDetails" %>
...
<div class="row margin-top-15 no-padding">
