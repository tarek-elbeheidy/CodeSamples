...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PAReviewerDisplayApplicantDetails.ascx.cs" Inherits="ITWORX.MOEHEWF.PA.CONTROLTEMPLATES.ITWORX.MOEHEWF.PA.PAReviewerDisplayApplicantDetails" %>
...
<div id="applicantDetails">
    ...
    <div class="row margin-2">
                <div class="col-md-6 col-sm-12 col-sm-6 col-xs-12">
    ...
    <div class="row no-padding">
        <asp:Button ID="btn_Print" runat="server" Text="<%$Resources:ITWORX_MOEHEWF_UCE, Print %>" OnClientClick="Print(this)" CssClass="btn moe-btn pull-right" Visible="false" />
    </div>
</div>
