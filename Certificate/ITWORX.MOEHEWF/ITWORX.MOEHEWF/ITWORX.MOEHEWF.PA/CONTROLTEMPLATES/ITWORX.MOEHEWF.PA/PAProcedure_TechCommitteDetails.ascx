...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PAProcedure_TechCommitteDetails.ascx.cs" Inherits="ITWORX.MOEHEWF.PA.CONTROLTEMPLATES.ITWORX.MOEHEWF.PA.Procedure_TechCommitteDetails" %>
