...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PASearchRequests.ascx.cs" Inherits="ITWORX.MOEHEWF.PA.CONTROLTEMPLATES.ITWORX.MOEHEWF.PA.PASearchRequests" %>
    ...
    <div class="row no-padding heighlighted-section margin-bottom-50 flex-display flex-wrap">
                ...
                <div class="form-group">
                    ...
                    <div class="form">
                        ...
                        <asp:RegularExpressionValidator ID="regVal_NumbersOnly" ControlToValidate="txt_RequestID" ValidationExpression="^[a-zA-Z0-9_.-]*$" ValidationGroup="Srch"
                            Display="Static" EnableClientScript="true" ErrorMessage="<%$Resources:ITWORX_MOEHEWF_PA, NumbersaAndAlphaOnly %>" runat="server" CssClass="error-msg moe-full-width" />
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="form-group">
                    ...
                    <div class="form">
                        ...
                        <asp:RegularExpressionValidator ID="regVal_NumbersOnlyID" ControlToValidate="txt_NationalID" ValidationExpression="\d+" ValidationGroup="Srch" Display="Static"
                            EnableClientScript="true" ErrorMessage="<%$Resources:ITWORX_MOEHEWF_PA, NumbersOnly %>" runat="server" CssClass="error-msg moe-full-width" />
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 no-padding">
            <div class="data-container table-display  ">
                <div class="form-group">
                    <h6 class="font-size-16 margin-bottom-10 margin-top-10">
                        <asp:Label ID="lbl_Nationality" runat="server" Text="<%$Resources:ITWORX_MOEHEWF_PA, Nationality %>  "></asp:Label>
                    </h6>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 no-padding">
            <div class="data-container table-display  ">
                <div class="form-group">
                    <h6 class="font-size-16 margin-bottom-10 margin-top-10">
                        <asp:Label ID="lbl_DateFrom" runat="server" Text="<%$Resources:ITWORX_MOEHEWF_PA, SubmitDateFrom %>"></asp:Label>
                    </h6>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 no-padding">
            <div class="data-container table-display  ">
                <div class="form-group">
                    <h6 class="font-size-16 margin-bottom-10 margin-top-10">
                        <asp:Label ID="lbl_DateTo" runat="server" Text="<%$Resources:ITWORX_MOEHEWF_PA, SubmitDateTo %> "></asp:Label>
                    </h6>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 no-padding">
            <div class="data-container table-display  ">
                <div class="form-group">
                    <h6 class="font-size-16 margin-bottom-10 margin-top-10">
                        <asp:Label ID="lbl_NationCategory" runat="server" Text="<%$Resources:ITWORX_MOEHEWF_PA, NationalityCategory %> "></asp:Label>
                    </h6>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 no-padding">
            <div class="data-container table-display  ">
                <div class="form-group">
                    <h6 class="font-size-16 margin-bottom-10 margin-top-10">
                        <asp:Label ID="lbl_Country" runat="server" Text="<%$Resources:ITWORX_MOEHEWF_PA, Country %> "></asp:Label>
                    </h6>

                    <div class="form">
                        <asp:DropDownList ID="drp_Country" runat="server" onchange="ddl_Countrychanged()" CssClass="moe-dropdown moe-full-width moe-input-padding moe-select input-height-42" OnSelectedIndexChanged="drp_Country_SelectedIndexChanged" AutoPostBack="true" EnableViewState="false">
                        </asp:DropDownList>
                    </div>
                </div>
            </div>
                ...
                <div class="form-group">
                      <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            ...
                            <h6 class="font-size-16 margin-bottom-10 margin-top-10">
                                <asp:Label ID="lbl_University" runat="server" Text="<%$Resources:ITWORX_MOEHEWF_PA, UniversityName %>"></asp:Label>
                            </h6>
                            <div class="form">
                                <asp:DropDownList ID="drp_University" runat="server" AutoPostBack="false" onchange="ddl_changed()"  CssClass="moe-dropdown moe-full-width moe-input-padding moe-select input-height-42" EnableViewState="false" ></asp:DropDownList>
                            </div>
                       </ContentTemplate>
                        <Triggers>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 no-padding">
            ...
            <div class="data-container table-display  ">
                <div class="form-group">
                            ...
                            <h6 class="font-size-16 margin-bottom-10 margin-top-10">
                                <asp:Label ID="lbl_Specialization" runat="server" Text="<%$Resources:ITWORX_MOEHEWF_PA, Specialization %> "></asp:Label>
                            </h6>
                            <div class="form">
            ...
            <div class="data-container table-display  ">
                <div class="form-group">
                    <h6 class="font-size-16 margin-bottom-10 margin-top-10">
                        ...
                        <asp:Label ID="lbl_Employee" runat="server" Text="<%$Resources:ITWORX_MOEHEWF_PA, Employee %>"></asp:Label>
                    </h6>
...
<asp:GridView ID="grd_Requests" runat="server" AutoGenerateColumns="false" AllowPaging="true" DataKeyNames="ID"
    ...
    <Columns>
        ...
        <asp:TemplateField HeaderText="<%$Resources:ITWORX_MOEHEWF_PA, responsibleOfficer %>">
            <ItemTemplate>

                <asp:Label ID="lbl_AssignedTo" runat="server" Text='<%# Eval("AssignedTo") %>'></asp:Label>
            </ItemTemplate>
        </asp:TemplateField>
        <asp:TemplateField HeaderText="<%$Resources:ITWORX_MOEHEWF_PA, RequestStatus %>">
            <ItemTemplate>
        ...
        <asp:TemplateField HeaderText="<%$Resources:ITWORX_MOEHEWF_PA, Action %>">
            <ItemTemplate>
                <asp:LinkButton ID="lnk_Edit" runat="server" Tootltip="<%$Resources:ITWORX_MOEHEWF_PA, Edit %>" CssClass="edit-icon fa fa-pencil-square-o" OnClick="lnk_Edit_Click"></asp:LinkButton>
                <asp:LinkButton ID="lnk_View" runat="server" ToolTip="<%$Resources:ITWORX_MOEHEWF_PA, View %>" CssClass="display-icon fa fa-eye" OnClick="lnk_View_Click"></asp:LinkButton>
            </ItemTemplate>
        </asp:TemplateField>
    </Columns>
</asp:GridView>
