...
{
    public partial class ProgramManager : LayoutsPageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Session["ActionTaken"] != null)
            {
                if (Session["ActionTaken"].ToString() == "AddNewProcedure")
                    LastLoadedControl = BASE_PATH + "PAAdd_ProcedureProgramManager.ascx";
                else if (Session["ActionTaken"].ToString() == "AddNewRecommendation")
                    LastLoadedControl = BASE_PATH + "PAAdd_NewRecommendation.ascx";
            }
