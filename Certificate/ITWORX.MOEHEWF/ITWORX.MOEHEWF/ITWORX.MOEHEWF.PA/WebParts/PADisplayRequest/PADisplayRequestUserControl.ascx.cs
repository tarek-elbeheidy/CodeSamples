...
namespace ITWORX.MOEHEWF.PA.WebParts.PADisplayRequest
{
    public partial class PADisplayRequestUserControl : UserControlBase
    {
       
        protected void Page_Load(object sender, EventArgs e)
        {
            //Logging.GetInstance().Debug("Entering method PADisplayRequestUserControl.Page_Load");
            //try
            //{
            //    //if (!Page.IsPostBack)
                //{
            ...
            //    Logging.GetInstance().Debug("Exiting method PADisplayRequestUserControl.Page_Load");
            //}
    ...
    /*
        protected void wizardPADisplayRequest_PreRender(object sender, EventArgs e)
        {
            Logging.GetInstance().Debug("Entering PADisplayRequestUserControl.wizardPADisplayRequest_PreRender");
            try
            {

                Repeater SideBarList = wizardPADisplayRequest.FindControl("HeaderContainer").FindControl("SideBarList") as Repeater;
                SideBarList.DataSource = wizardPADisplayRequest.WizardSteps;
            ...
            finally
            {
                ...
                Logging.GetInstance().Debug("Exit PADisplayRequestUserControl.wizardPADisplayRequest_PreRender");
            }
        }

        public string GetClassForWizardStep(object wizardStep)
        {
            Logging.GetInstance().Debug("Entering PADisplayRequestUserControl.GetClassForWizardStep");
            ...
            try
            {
                ...
                int stepIndex = wizardPADisplayRequest.WizardSteps.IndexOf(step);

                if (stepIndex < wizardPADisplayRequest.ActiveStepIndex)
                {
                    stepText = "prevStep";
                }
                else if (stepIndex > wizardPADisplayRequest.ActiveStepIndex)
                {
                    stepText = "nextStep";
                }
                else
            ...
            finally
            {
                ...
                Logging.GetInstance().Debug("Exit PADisplayRequestUserControl.GetClassForWizardStep");
            }
            return stepText;
        }
     ...
     */
        ...
        {
            Logging.GetInstance().Debug("Entering method PADisplayRequestUserControl.PADisplayRequestData");
            try
            {
                ...
                if (requestItem != null)
                {
                    ...
                    lblHighestCertificateValue.Text = requestItem.AcademicDegree.SelectedTitle;
                    ...
                    lblStartDateValue.Text = requestItem.AcademicStartDate.ToShortDateString();
                    if (requestItem.AcademicStartDate != DateTime.MinValue)
                    {
                        lblGraduationDate.Visible = true;
                        lblGraduationDateValue.Visible = true;
                        lblGraduationDateValue.Text = requestItem.AcademicStartDate.ToShortDateString();
                    }
            ...
            finally
            {
                ...
                Logging.GetInstance().Debug("Exiting method PADisplayRequestUserControl.PADisplayRequestData");
            }

        }
        protected void lnkDownload_Click(object sender, EventArgs e)
        {
            Logging.GetInstance().Debug("Entering method PADisplayRequestUserControl.lnkDownload_Click");
            try
            {
            ...
            finally
            {
                ...
                Logging.GetInstance().Debug("Exiting method PADisplayRequestUserControl.lnkDownload_Click");
            }
        ...
        {
            Logging.GetInstance().Debug("Entering method PADisplayRequestUserControl.lnkDownloadCopy_Click");
            try
            {
                int itemId = int.Parse((sender as LinkButton).CommandArgument);
            ...
            finally
            {
                ...
                Logging.GetInstance().Debug("Exiting method PADisplayRequestUserControl.lnkDownloadCopy_Click");
            }
        ...
        {
            Logging.GetInstance().Debug("Entering method PADisplayRequestUserControl.gridUniversitiesNames_RowDataBound");
            try
            {
            ...
            finally
            {
                ...
                Logging.GetInstance().Debug("Exiting method PADisplayRequestUserControl.gridUniversitiesNames_RowDataBound");
            }
