...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PAReviewerDecisionsUserControl.ascx.cs" Inherits="ITWORX.MOEHEWF.PA.WebParts.PAReviewerDecisions.PAReviewerDecisionsUserControl" %>
