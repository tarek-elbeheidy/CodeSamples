...
<%@ Register Src="~/_controltemplates/15/ITWORX.MOEHEWF.PA/PADisplayPARequestDetails.ascx" TagPrefix="uc1" TagName="PADisplayPARequestDetails" %>
...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PARequestDetailsUserControl.ascx.cs" Inherits="ITWORX.MOEHEWF.PA.WebParts.PARequestDetails.PARequestDetailsUserControl" %>
