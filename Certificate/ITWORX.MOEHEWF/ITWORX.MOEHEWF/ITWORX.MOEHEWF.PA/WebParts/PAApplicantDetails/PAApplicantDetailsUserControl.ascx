...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PAApplicantDetailsUserControl.ascx.cs" Inherits="ITWORX.MOEHEWF.PA.WebParts.PAApplicantDetails.PAApplicantDetailsUserControl" %>
