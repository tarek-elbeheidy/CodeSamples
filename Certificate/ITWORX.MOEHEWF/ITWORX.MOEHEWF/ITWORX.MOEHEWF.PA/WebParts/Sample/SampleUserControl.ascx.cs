    ...
    public partial class SampleUserControl : UserControlBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                Literal1.Text = HelperMethods.LocalizedText("ITWORX_MOEHEWF_PA", "LocalSample", (uint)LCID);
        ...
        private void Method()
        {
            ...
            List<ITWORX.MOEHEWF.PA.Entities.AcademicDegree> academics = ITWORX.MOEHEWF.PA.BL.AcademicDegree.GetAll();
            ...
            fileUpload.MaxSize = 10240000;//10MB
