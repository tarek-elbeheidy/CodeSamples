...
namespace ITWORX.MOEHEWF.PA.Entities
{
    ...
    {
        private string _EarnedHours;
        public string EarnedHours
        {
            get
            {
                return _EarnedHours;
        ...
        private string _OnlineHoursPer;
        public string OnlineHoursPer
        {
            get
            {
                return _OnlineHoursPer;
            }
            set
            {
                _OnlineHoursPer = value;
            }
        } 
        ...
        private string _PARecommendationstatus;
        public string PARecommendationstatus
        {
            get
            {
                return _PARecommendationstatus;
            }
            set
            {
                _PARecommendationstatus = value;
            }
        }
