...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="NewUser.ascx.cs" Inherits="ITWORX.MOEHEWF.Common.CONTROLTEMPLATES.ITWORX.MOEHEWF.Common.NewUser" %>
...
<br />
<asp:Button ID="btnResetPassword" runat="server" ValidationGroup="Create" Text="<%$Resources:ITWORX.MOEHEWF.Common, CreateNewUser %>" />
